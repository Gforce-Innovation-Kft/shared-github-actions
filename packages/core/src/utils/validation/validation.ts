/**
 * Generic input parsers shared by the action adapters' `inputValidator` layers.
 * These operate on raw strings (the shape GitHub Action inputs arrive in) and
 * throw {@link ValidationError} on bad data.
 */
