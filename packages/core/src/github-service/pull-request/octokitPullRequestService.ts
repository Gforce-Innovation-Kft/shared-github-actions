/**
 * The Octokit-backed {@link PullRequestService}. Talks to `@octokit/rest` only
 * for PR operations; the constructor is injectable and the singleton statics
 * share the one {@link GitHubClient}.
 */
